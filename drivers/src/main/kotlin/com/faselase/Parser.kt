...
class Parser(private val filter: Boolean) : Parser<Byte, Package> {
    override fun invoke(buffer: List<Byte>): ParseInfo<Package> {
    ...
    private companion object {
        const val k_rho = 40.0 / 4096
        const val k_theta = 2 * PI / 5760
        ...
        fun crcCheck(`package`: List<Byte>): Boolean {
        ...
        fun Byte.takeBits(mask: Int, p: Int) =
